...
Personal preferences include the chosen interface language, whether the
introduction was completed and the last acknowledged Vorrio version. They
contain no secret and are exported so a household can understand why a
language, guide or release note appears. Complete erasure deletes these records
with the account.

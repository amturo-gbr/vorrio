...
## Planned first option

GitHub Sponsors is the preferred launch option after the public Amturo
organization and repository exist. It supports one-time and recurring tiers and
keeps the support link next to the source through `.github/FUNDING.yml`.

Suggested launch tiers:

- Supporter: small recurring contribution;
- Household sponsor: recurring maintenance support;
...
No payment link is active in 0.8.18. Funding configuration is added only after

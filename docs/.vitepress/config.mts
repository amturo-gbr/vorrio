...
const deSidebar: DefaultTheme.SidebarItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Finanzierung", link: "/de/FUNDING" },
    ],
  },
];
...
export default defineConfig({
  ...
  head: [
    ...
    ["meta", { property: "og:image", content: `${origin}/vorrio-social-card-en.png` }],
    ["meta", { property: "og:image:width", content: "1200" }],
    ["meta", { property: "og:image:height", content: "630" }],
    ["meta", { name: "twitter:card", content: "summary_large_image" }],
    ["meta", { name: "twitter:image", content: `${origin}/vorrio-social-card-en.png` }],
